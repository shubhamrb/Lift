...
public class RideRequestPresenter extends BasePresenter<RideRequestView> {
    ...
    public void openMyRidesFragment() {
        navigator.openMyRidesFragment(BaseActivity.PerformFragment.REPLACE);
    }
}
