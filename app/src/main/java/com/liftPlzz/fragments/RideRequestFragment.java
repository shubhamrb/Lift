...
public class RideRequestFragment extends BaseFragment<RideRequestPresenter, RideRequestView> implements RideRequestView, RideRquestAdapter.ItemListener, PartnerAdapter.ItemListener {
    ...
    private void blockUser(Integer user_id, String reason) {
        Constants.showLoader(getActivity());
        ApiService api = RetroClient.getApiService();
        Call<JsonObject> call = api.blockUser(Constants.API_KEY, Constants.ANDROID, strToken, user_id, reason);
    ...
    public void onBlockReportClick(int position, Integer user_id) {
        ...
        dialog.setContentView(R.layout.report_reason_dialog);
        ...
        RadioButton radio4 = dialog.findViewById(R.id.radio4);
        RadioButton radio5 = dialog.findViewById(R.id.radio5);
        ...
        titleTxt.setText("Reason to report?");
        ...
        buttonSubmit.setOnClickListener(v -> {
            ...
            } else if (reason_group.getCheckedRadioButtonId() == R.id.radio4) {
                reason = radio4.getText().toString();
            } else if (reason_group.getCheckedRadioButtonId() == R.id.radio5) {
                reason = radio5.getText().toString();
            } else {
